...
Instead of coding at a whiteboard with someone watching over your shoulder under high pressure, which is not a thing we often do, we instead give out an engineering assignment for you to work on with your own tools and that we can discuss when we meet.
...
*   Our team builds, alongside our customers, systems engineered to run in production. Given this, please organize, design, test, deploy, and document your solution as if you were going to put into production. We completely understand this might mean you can't do as much in the time budget.
